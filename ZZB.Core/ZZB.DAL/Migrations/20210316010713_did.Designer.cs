            ...
            modelBuilder.Entity("ZZB.DAL.Admin.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountID = "zzb",
                            CreateDate = new DateTime(2021, 3, 16, 9, 7, 12, 872, DateTimeKind.Local).AddTicks(4391),
                            IsAdministrator = true,
                            ModifyDate = new DateTime(2021, 3, 16, 9, 7, 12, 873, DateTimeKind.Local).AddTicks(1091),
                            PassWork = "123",
                            Status = 0,
                            UserName = "拿破仑"
                        });
