...
namespace ZZB.DAL.Migrations
{
    ...
    [Migration("20210309151441_editdocument19")]
    partial class editdocument19
    {
            ...
            modelBuilder.Entity("ZZB.DAL.Admin.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountID = "zzb",
                            CreateDate = new DateTime(2021, 3, 9, 23, 14, 40, 686, DateTimeKind.Local).AddTicks(4208),
                            IsAdministrator = true,
                            ModifyDate = new DateTime(2021, 3, 9, 23, 14, 40, 687, DateTimeKind.Local).AddTicks(934),
                            PassWork = "123",
                            Status = 0,
                            UserName = "拿破仑"
                        });
