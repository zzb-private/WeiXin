            ...
            modelBuilder.Entity("ZZB.DAL.Admin.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountID = "zzb",
                            CreateDate = new DateTime(2021, 3, 6, 16, 38, 12, 883, DateTimeKind.Local).AddTicks(1934),
                            IsAdministrator = true,
                            ModifyDate = new DateTime(2021, 3, 6, 16, 38, 12, 884, DateTimeKind.Local).AddTicks(696),
                            PassWork = "123",
                            Status = 0,
                            UserName = "拿破仑"
                        });
