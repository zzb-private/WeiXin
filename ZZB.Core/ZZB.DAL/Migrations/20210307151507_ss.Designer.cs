            ...
            modelBuilder.Entity("ZZB.DAL.Admin.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountID = "zzb",
                            CreateDate = new DateTime(2021, 3, 7, 23, 15, 6, 720, DateTimeKind.Local).AddTicks(7811),
                            IsAdministrator = true,
                            ModifyDate = new DateTime(2021, 3, 7, 23, 15, 6, 721, DateTimeKind.Local).AddTicks(4642),
                            PassWork = "123",
                            Status = 0,
                            UserName = "拿破仑"
                        });
