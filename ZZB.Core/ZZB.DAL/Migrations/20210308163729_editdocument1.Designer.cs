...
namespace ZZB.DAL.Migrations
{
    ...
    [Migration("20210308163729_editdocument1")]
    partial class editdocument1
    {
            ...
            modelBuilder.Entity("ZZB.DAL.Admin.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountID = "zzb",
                            CreateDate = new DateTime(2021, 3, 9, 0, 37, 29, 18, DateTimeKind.Local).AddTicks(7864),
                            IsAdministrator = true,
                            ModifyDate = new DateTime(2021, 3, 9, 0, 37, 29, 19, DateTimeKind.Local).AddTicks(4172),
                            PassWork = "123",
                            Status = 0,
                            UserName = "拿破仑"
                        });
